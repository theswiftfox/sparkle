...
Engine::Texture::Texture(const aiTexture * tex, size_t typeID, std::string id) : filePath(id), typeID(typeID)
{
...
Texture::Texture(void* data, int width, int height, int channels, size_t typeID, std::string id) : filePath(id), typeID(typeID) {
